        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 items-center gap-12">
          ...
          <div className="z-10">
            <h2 className="text-3xl sm:text-4xl xl:text-5xl 2xl:text-[60px] font-light">
              Our <span className="font-extrabold">Journey</span>
            </h2>
            <p className="text-black/80 text-base xl:text-lg 2xl:text-[22px] mb-9  mx-auto lg:mx-0 2xl:leading-relaxed font-light mt-9">
              Founded at the beginning of 2025 as AI momentum begins to gain
              traction, Ben Owen and Romain Picard, two founders who have
              previously worked together in the past; decided that too often big
              platform re-sellers, consultancies and systems integrators were
              writing the playbook as it happened, uncertain of where the tech
              was going, and unsure of market needs and dynamics. Meanwhile they
              would charge abhorrent fees with no clear success metrics apart
              from billable hours.
            </p>
