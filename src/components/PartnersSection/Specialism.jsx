    ...
    <section className="bg-[#E8E8E8] max-w-[1920px] mx-auto w-full py-8 sm:py-10 lg:py-12 xl:py-16 relative overflow-hidden">
      <div className="font-raleway px-4 sm:px-6 md:px-8 lg:px-[100px] 2xl:px-[178px] mx-auto text-center">
        <h2 className="mt-7 text-3xl sm:text-4xl md:text-[41px] 2xl:text-[60px] font-medium text-black leading-tight">
          Our <span className="font-bold">Specialisms</span> Include
        </h2>
        <p className="2xl:text-[22px] mx-auto lg:text-sm text-sm  text-black 2xl:leading-relaxed pt-9 lg:mt-0">
          Technology & Application Partners (Microsoft, AWS, Google, PowerBI,
          Informatica, SAS). Horizontally managing Think / Build / Run System
          Integrator partners (BGC, EY, Accenture, Deloitte, IBM, ATOS,
          Capgemini, Devoteam, Claranet). Growing Business through Strategic
          Partnership either Sell-To / Sell-Through or Sell-With motions
        </p>
        <p className="font-semibold 2xl:text-[22px] mt-6 text-[#333]">
          Our team is comfortable with the following tools and technologies
        </p>
        ...
        <div className="flex justify-center mt-6 flex-wrap gap-0 relative z-0">
          {tabs.map((tab, index) => (
            <button
              ...
              className={`w-full max-w-[180px] sm:max-w-[200px] md:max-w-[210px] h-[52px] sm:h-[58px] md:h-[62px] border text-sm sm:text-base font-medium transition-all duration-300 2xl:-ml-[30px] relative z-0 rounded-[10px] ${
                activeTab === index
